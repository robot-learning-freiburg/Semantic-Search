...
from nicr_mt_scene_analysis.model.decoder import (
    InstanceDecoder,
    InstanceMLPDecoder,
    NormalDecoder,
    NormalMLPDecoder,
    PanopticHelper,
    SceneClassificationDecoder,
    SemanticDecoder,
    SemanticMLPDecoder,
)
    ...
    if "semantic" in args.tasks:
        ...
        if "emsanet" == decoder_type:
            semantic_decoder = SemanticDecoder(
                ...
                fusion=get_encoder_decoder_fusion_class(
                    args.semantic_encoder_decoder_fusion
                ),
    ...
    if "instance" in args.tasks:
        ...
        if "emsanet" == decoder_type:
            instance_decoder = InstanceDecoder(
                ...
                fusion=get_encoder_decoder_fusion_class(
                    args.instance_encoder_decoder_fusion
                ),
    ...
    if "normal" in args.tasks:
        ...
        if "emsanet" == decoder_type:
            normal_decoder = NormalDecoder(
                ...
                fusion=get_encoder_decoder_fusion_class(
                    args.normal_encoder_decoder_fusion
                ),
